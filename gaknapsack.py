...
class GA(object):
    ...
    def create_objects(self):
        ...
        for i in range (self.n_objects):
             lista_objetos.append({"value": randrange(0, self.n_objects), "weight": randrange(0, self.max_weight)})
        return lista_objetos
        """ Concluido ainda a duvidas"""
    ...
    def start_generation(self):
        ...
        for i in range (self.generation_size):
            ...
            for k in range (self.n_objects):
                lista_objetos.append(randrange(0, 2))
            lista_geracao1.append(lista_objetos)
        return lista_geracao1
        """ Concluido """
    ...
    def compete(self, solutions):
        ...
        maior_fitness = lista_fitness[0]
        posicao_fitness = 0

        for i in range(len(lista_fitness)):
            if lista_fitness[i] > maior_fitness:
                maior_fitness = lista_fitness[i]
                posicao_fitness = i

        return solutions[posicao_fitness]
        """ Concluido """
